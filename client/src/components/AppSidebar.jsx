...
import { RouteBlog, RouteBlogByCategory, RouteCategoryDetails, RouteCommentDetails, RouteIndex, RouteUser, RouteSiteSettings } from "@/helpers/RouteName";
                        ...
                        {user && user.isLoggedIn && user.user.role === 'admin'
                            ? <>
                                ...
                                <SidebarMenuItem>
                                    <SidebarMenuButton>
                                        <IoSettingsOutline />
                                        <Link to={RouteSiteSettings}>Site Settings</Link>
                                    </SidebarMenuButton>
                                </SidebarMenuItem>
                            </>
                            :
